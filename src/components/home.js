    ...
    return (
        <div className='max-w-screen-2xl mx-auto'>
            ...
            <div className='px-10 py-28 bg-red-700'>
                ...
                <div className="product-wrapper  pt-28 px-6 grid grid-cols-5 gap-10 select-none">

                    {
                        products.map((product, i) => {
                            return (
                                <Link key={product.id} to={`/san-pham/id=${product.id}`}
                                    className="product-item block transition-transform bg-red-500 hover:scale-105 p-3 hover:border rounded-lg ">
